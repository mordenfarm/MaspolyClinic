...
const PharmacyTab: React.FC<PharmacyTabProps> = ({ inventory, onNotify, readOnly = false }) => {
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-6">
        ...
        <div className="flex flex-wrap gap-2 w-full lg:w-auto">
           ...
           {!readOnly && <Button variant="primary" onClick={() => { setEditingItem(null); setIsModalOpen(true); }} className="bg-mPolyGreen shrink-0 shadow-lg">New Item</Button>}
        </div>
      </div>
          ...
          <table className="w-full text-left">
            <thead className="bg-mPolyBlue text-white text-[9px] font-black uppercase tracking-widest">
              <tr>
                ...
                {!readOnly && <th className="p-5 text-right">Actions</th>}
              </tr>
            </thead>
