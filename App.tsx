...
import ReferralVerificationPage from './ReferralVerificationPage';
...
const App: React.FC = () => {
  ...
  const referralVerificationId = verificationParams.get('verifyReferral') || '';
  const sickNoteVerificationId = verificationParams.get('verifySickNote') || '';
  const clinicalRecordVerificationId = verificationParams.get('verifyRecord') || '';
  ...
  if (referralVerificationId) {
    return <ReferralVerificationPage referralId={referralVerificationId} />;
  }

  if (sickNoteVerificationId) {
    return <ReferralVerificationPage documentType="sickNote" documentId={sickNoteVerificationId} />;
  }

  if (clinicalRecordVerificationId) {
    return <ReferralVerificationPage documentType="clinicalRecord" documentId={clinicalRecordVerificationId} />;
  }
